...
from stats.templatetags import stats_extras
...
class templatetags(TestCase):
    ...
    def test__stats_extras__player_value(self):
        self.assertEqual(stats_extras.player_value(self.participation1), math.sqrt(120 * 20 / (15 * 100)))
